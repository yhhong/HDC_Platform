...
public class CommonController {
    ...
    public LoginByUnifyTokenResp loginByUnityToken(@RequestBody(required = false) String json) {
        ...
        resp.data.userToken = "user_token_1";
        resp.data.userId = "userId_1";
        resp.data.portrait = Pic.PIC1;
        resp.result = 0;
    ...
    public LoginBySmsCaptchaResp loginBySmsCaptcha(@RequestBody(required = false) String json) {
        ...
        resp.data = resp.new Data();
        resp.data.userToken = "user_token_2";
        resp.data.userId = "userId_2";
        resp.data.portrait = Pic.PIC2;
        resp.result = 0;
        resp.message = "success";
        return resp;
    }
