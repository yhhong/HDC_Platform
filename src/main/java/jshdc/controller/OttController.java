...
import jshdc.bean.response.ott.DeleteCollectContentResp;
import jshdc.bean.response.ott.GetCategoriesResp;
import jshdc.bean.response.ott.GetChannelDetailResp;
import jshdc.bean.response.ott.GetChannelProgramsResp;
import jshdc.bean.response.ott.GetChannelTagsResp;
import jshdc.bean.response.ott.GetChannelsResp;
import jshdc.bean.response.ott.GetCollectContentsResp;
import jshdc.bean.response.ott.GetColumnsResp;
import jshdc.bean.response.ott.GetPlayRecordsResp;
import jshdc.bean.response.ott.GetProgramDetailResp;
import jshdc.bean.response.ott.GetRelevantRecommendResp;
import jshdc.bean.response.ott.GetTeleplayDetailResp;
import jshdc.bean.response.ott.GetTeleplayVideosResp;
import jshdc.bean.response.ott.GetVideoDetailResp;
import jshdc.bean.response.ott.GetVodContentsResp;
import jshdc.bean.response.ott.GetVodTagsResp;
import jshdc.bean.response.ott.PostCollectContentResp;
import jshdc.bean.response.ott.PostPlayRecordResp;
import jshdc.bean.response.ott.SearchResp;
 ...
 */
@RestController public class OttController {
  ...
  public GetCategoriesResp getCategories(@RequestBody(required = false) String json) {
  ...
  public GetChannelProgramsResp getChannelPrograms(@RequestBody(required = false) String json) {
    GetChannelProgramsResp resp = new GetChannelProgramsResp();
